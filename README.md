...
creamos una app la cual se puedan ver distintas recetas de comida junto con información relevante de las mismas utilizando la api externa [spoonacular](https://spoonacular.com/food-api) y a partir de ella poder, entre otras cosas:
...
### Únicos Endpoints/Flags utilizado de la api externa  son:
...
Utilizaremos una aplicación de React/Redux que contenga las siguientes pantallas/rutas.
...
El modelo de la base de datos contiene siguientes entidades (Aquellas propiedades marcadas con asterisco deben ser obligatorias):
